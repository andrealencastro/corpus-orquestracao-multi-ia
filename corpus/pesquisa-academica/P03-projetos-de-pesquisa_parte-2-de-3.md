...
observed switching⇏strategic switching.\\text{observed switching} \\not\\Rightarrow \\text{strategic switching}.
...
semantic switching≉domain-general exploration.\\text{semantic switching} \\not\\approx \\text{domain-general exploration}.
...
additional lexical variation↛additional inferential competence\\text{additional lexical variation} \\not\\rightarrow \\text{additional inferential competence}
